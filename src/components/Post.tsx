      ...
      <div className="flex flex-col gap-2">
        ...
        <div>
          <p className="mb-4">
            ...
            impedit assumenda ex est? Sint perspiciatis rerum impedit accusamus
            officiis, non quaerat quo consequatur cumque fuga nesciunt
            molestias, praesentium, saepe voluptatum.
          </p>
          <img
        ...
        <div className="flex justify-between w-full">
          ...
          <div className="flex items-center">
            ...
            <Button
              size="sm"
              className="font-bold bg-pink-700 hover:bg-pink-800 rounded-xl space-x-2"
            >
