...
export function SliderRating({ ratings }: SliderRatingProps) {
  ...
  console.log(goodRating, badRatings)
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        <SliderPrimitive.Track className={`relative h-1 w-full grow overflow-hidden rounded-full ${(ratingsPercentage > 0 || badRatings.length > 0) ? 'bg-red-500' : 'bg-zinc-100'}`}>
